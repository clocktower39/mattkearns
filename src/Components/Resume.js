            ...
            <Grid container item sm={12} md={8} className={classes.main}>
              ...
              <Grid container item xs={12} className={classes.mainSubDescriptioin}>
                ...
                <Grid item xs={12}>
                  ...
                  <Typography variant="subtitle1"> -Lists fitness exercises by muscle group and provides a description</Typography>
                </Grid>
                <Grid item xs={12}>
                  <Typography variant="h6"><a className={classes.exampleLinks} href="https://madeupbymaria.com">Makeup Site</a></Typography>
                  <Typography variant="subtitle1"> -Client makeup site</Typography>
                </Grid>
                <Grid item xs={12}>
                  <Typography variant="h6"><a className={classes.exampleLinks} href="https://mattkearns.dev/social-picture-app/">Social Picture App</a></Typography>
                  <Typography variant="subtitle1"> -Instagram mock application</Typography>
                </Grid>
                <Grid item xs={12}>
                  <Typography variant="h6"><a className={classes.exampleLinks} href="https://mattkearns.dev/message">Messenger App</a></Typography>
                  <Typography variant="subtitle1"> -Messager app using socket.io for real time updates</Typography>
                </Grid>
              </Grid>
